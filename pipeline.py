...
from trs.sources import census, edgar, sos, website
...
def cmd_run(args):
    ...
    sources = [args.source] if args.source else ["census", "edgar", "sos", "website"]
    start = time.time()
    for name in sources:
...
def main():
    ...
    pr.add_argument("--source", choices=["census", "edgar", "sos", "website"], default=None)
